...
if __name__ == "__main__":
    registered_envs = [env_id for env_id in gym.envs.registry.keys() if 'tarware' in env_id]
    print(f"Registered environments: {registered_envs}")

    env = gym.make("tarware-medium-19agvs-5pickers-partialobs-v1")
    seed = args.seed
